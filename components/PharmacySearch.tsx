  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
        <h1 className="text-3xl font-bold mb-4 text-blue-700">🔍 Pharmacy & Clinic Locator</h1>
        <p className="text-gray-600 mb-6">
          Find nearby <strong>pharmacies, clinics, and hospitals</strong> using a place name or your current location.
        </p>
        ...
        <div className="mb-6 flex items-center gap-2">
          <input
            ...
            onChange={() => setIncludeHospitals(!includeHospitals)}
            id="includeHospitals"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {results.map((place, idx) => (
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-2">Type: {place.tags?.amenity || "Unknown"}</p>
                <a
